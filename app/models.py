...
class Symptom(Base):
    ...
    category_code: Mapped[str] = mapped_column(String(3), ForeignKey("symptom_categories.code"), nullable=False)
...
class CaseSymptomWeight(Base):
    ...
    symptom_code: Mapped[str] = mapped_column(String(3), ForeignKey("symptoms.code"), primary_key=True)
...
class CaseSolution(Base):
    ...
    case_id: Mapped[int] = mapped_column(ForeignKey("cases.id"), primary_key=True)
    solution_code: Mapped[str] = mapped_column(String(3), ForeignKey("solutions.code"), primary_key=True)
